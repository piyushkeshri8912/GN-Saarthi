...
from app.services.rag_service import generate_rag_answer_stream
...
@router.post("/stream")
async def chat_stream(request: ChatRequest, current_user: User = Depends(verify_token)):
    """
    ...
    try:
        ...
        return StreamingResponse(
            generate_rag_answer_stream(request.message, session_id=request.session_id),
